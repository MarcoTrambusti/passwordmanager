...
public class UserRepositoryIT {
	...
	public void testFindAll () {
		...
		assertThat(users.get(0).getUsername().equals(u1.getUsername()) && users.get(0).getEmail().equals(u1.getEmail()) && users.get(0).getPassword().equals(u1.getPassword())).isTrue();
		assertThat(users.get(1).getUsername().equals(u2.getUsername()) && users.get(1).getEmail().equals(u2.getEmail()) && users.get(1).getPassword().equals(u2.getPassword())).isTrue();
	}
	...
	public void testFindById() {
		...
		assertThat(u.getUsername().equals(u2.getUsername()) && u.getEmail().equals(u2.getEmail()) && u.getPassword().equals(u2.getPassword())).isTrue();
	}
	...
	public void testSaveUser() {
		...
		assertThat(savedUser.getUsername().equals(u1.getUsername()) && savedUser.getEmail().equals(u1.getEmail()) && savedUser.getPassword().equals(u1.getPassword())).isTrue();
	}
